...
namespace ritchell.library.tests
{
    ...
    public class Class1
    {
        ...
        public void AddBookCopyTest()
        {
            ...
            BookCopy bookCopy1 = BookCopy.MakeCopy(bookInfo, "bookTag1");
            BookCopy bookCopy2 = BookCopy.MakeCopy(bookInfo, "bookTag2");
            bookCopyService.AddBookCopy(bookCopy1);
            bookCopyService.AddBookCopy(bookCopy2);

            var bookCopies = bookService.GetBooks().First().BookCopies;
